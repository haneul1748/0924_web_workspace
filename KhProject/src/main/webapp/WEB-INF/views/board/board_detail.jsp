				...
				<div class="offset-lg-2 col-lg-8">
					<div class="card">
						<div class="card-header text-white"
							style="background-color: #52b1ff;">${ map.board.boardNo }번
							게시물 내용</div>
						<div class="card-body">

							<div class="form-group">
								<label>카테고리</label><br> <span>${ map.board.category }</span>
							</div>

							<div class="form-group">
								<label>작성자</label> <input type="text" class="form-control"
									name='writer' value="${ map.board.boardWriter }" readonly>
							</div>

							<div class="form-group">
								<label>제목</label> <input type="text" class="form-control"
									name='title' value="${ map.board.boardTitle }" readonly>
							</div>
							...
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${ map.at ne null }">
										<!-- 
							localhost:4000/kh/resources/board_upfiles/KHacademy_~~~.jpg
							 -->
										<!-- 첨부파일은 있을수도있음 -->
										<a download="${ map.at.originName }"
											href="${ map.at.filePath }/${map.at.changeName}">${ map.at.originName }</a>
										<br>
		           ...
		           -->
			          ...
			          <a class="btn"
									href="delete.board?boardNo=${ map.board.boardNo }"
