...
<body>
	...
	<%
		...
		String classRoom = (String)request.getAttribute("className");
	...
	<p>
		...
		<!-- 
			...
			해당 Person객체의 각 필드값을 출력하려고 한다면, 키값, 필드명을
			작성하면 해당 필드에 네이밍컨벤션에 부합하는 getter를 찾아서 호출해줌
		 -->
	...
	<p>
		...
		big이 small보다 크거나 같니? : ${ big >= small }<br>
		big이 small보다 작거나 같니? : ${ big <= small }<br>
	</p>
	...
	<p>
		...
		big과 10이 같습니까? : ${ big == 0 } 또는 {big eq 10 } <br>
		...
		strOne과 strTwo가 같지안습니까? : ${ strOne != strTwo } 또는 ${strOne ne strTwo } <br>
																<!-- ne : not equals -->
	</p>
